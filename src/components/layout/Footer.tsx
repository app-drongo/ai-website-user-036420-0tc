...
const DEFAULT_FOOTER = {
  logoText: 'TechFlow',
  companyDescription:
    'Empowering businesses with cutting-edge SaaS solutions. Join over 10,000 companies who trust our platform to streamline operations and accelerate growth.',
  ...
  const footerSections = [
    {
      ...
      links: [
        ...
        { name: 'Developer Tools', href: '/developers', editableId: 'link-footer-developers' },
      ],
    },
    {
    ...
    },
    {
      ...
      links: [
        ...
        { name: 'Live Training', href: '/training', editableId: 'link-footer-training' },

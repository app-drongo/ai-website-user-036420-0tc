...
const DEFAULT_FEATURES = {
  ...
  mainDescription:
    'Streamline your financial operations with our comprehensive accounting SaaS designed specifically for small businesses and growing enterprises.',
  ...
  feature2Description:
    'SOC 2 compliant with 256-bit encryption, multi-factor authentication, and complete audit trails for tax compliance.',
  feature2Badge: 'Security',
  feature3Title: 'Mobile Accounting App',
  feature3Description:
    'Manage invoices, track expenses, and view financial reports on-the-go with our native mobile application.',
  feature3Badge: 'Mobile',
  feature4Title: 'Multi-Entity Management',
  feature4Description:
    'Handle multiple business entities, subsidiaries, and locations from a single dashboard with consolidated reporting.',
  feature4Badge: 'Multi-Entity',
  feature5Title: 'Advanced Financial Reports',
  feature5Description:
    'Generate P&L statements, balance sheets, cash flow reports, and tax-ready documents with one-click automation.',
  feature5Badge: 'Reporting',
  feature6Title: 'Custom Invoice Workflows',
  feature6Description:
    'Automate recurring billing, payment reminders, and approval workflows to accelerate your cash collection cycle.',
  feature6Badge: 'Automation',
  feature7Title: 'QuickBooks & Bank Integration',
  feature7Description:
    'Seamlessly sync with 2,000+ banks, QuickBooks, PayPal, Stripe, and other financial platforms via secure APIs.',
  feature7Badge: 'Integration',
  feature8Title: '24/7 CPA Support',
  feature8Description:
    'Access certified public accountants and bookkeeping experts with guaranteed response times and tax season priority.',
  feature8Badge: 'Support',
  feature9Title: 'Data Backup & Privacy',
  feature9Description:
    'Your financial data is encrypted, backed up hourly, and stored in SOC 2 compliant data centers with 99.99% uptime.',

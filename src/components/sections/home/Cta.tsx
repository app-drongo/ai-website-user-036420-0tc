...
const DEFAULT_CTA = {
  ...
  description:
    'Join over 50,000 small businesses who trust our AI-powered accounting platform to save time, reduce errors, and grow their profits. Start your free trial today.',
  primaryCTA: 'Start 14-Day Free Trial',
  primaryCTAHref: '/signup',
  secondaryCTA: 'Book Demo with CPA',
  secondaryCTAHref: '/demo',
  trustText: 'Trusted by small businesses nationwide',
  stat1Value: '50K+',
  stat1Label: 'Small Businesses',
  stat2Value: '40hrs',
  stat2Label: 'Saved Monthly',
  stat3Value: '99.8%',
  stat3Label: 'Accuracy Rate',
  stat4Value: '24/7',
  stat4Label: 'CPA Support',
  feature1Title: 'No Credit Card',
  feature1Description: '14 days free access to all features',
  feature2Title: 'Bank-Level Security',
  feature2Description: '256-bit encryption and SOC 2 compliance',
  feature3Title: 'Quick Setup',
  feature3Description: 'Connect your bank and start in under 5 minutes',
} as const;
...
export default function Cta(props: CTAProps) {
  ...
  const stats = [
    ...
    { value: config.stat2Value, label: config.stat2Label, icon: TrendingUp },
    { value: config.stat3Value, label: config.stat3Label, icon: Calculator },
  ...
  return (
    <section className="py-24 relative overflow-hidden">
      ...
      <div className="absolute bottom-0 right-1/4 size-96 bg-primary/15 rounded-full blur-3xl opacity-20" />

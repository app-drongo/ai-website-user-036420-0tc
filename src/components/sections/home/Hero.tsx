...
const DEFAULT_HERO = {
  ...
  title: 'Simplify your small business',
  titleHighlight: 'accounting & finances',
  description:
    'Streamline invoicing, expense tracking, and financial reporting with our intuitive accounting software designed specifically for small businesses.',
  features: [
  ...
  imageAlt: 'Accounting dashboard interface',
